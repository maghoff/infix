...
describe('memoizing', function() {
	describe('compilerFor', function() {
		...
		it('should work multiple times for the same expression', function () {
			assert.equal(6, compile("2*(2+$0/4)")(4));
			assert.equal(8, compile("2*(2+$0/4)")(8));
			assert.equal(10, compile("2*(2+$0/4)")(12));
		});

		it('should handle mixed parameter ordering', function () {
			assert.equal(8, compile("$3*($2+$0/$1)")(8, 4, 2, 2));
		});

		it('should handle parameter gaps', function () {
			assert.equal(4, compile("$3")(1, 2, 3, 4, 5, 6));
		});
	...
	describe('evaluatorFor', function() {
